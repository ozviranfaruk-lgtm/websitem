...
import Hero from '../components/Hero'; // O kamyonlu kapak resmini çağırıyoruz

function Home() {
  return (
    <div>
      {/* 1. KAMYONLU KAPAK RESMİ (Hero) */}
      <Hero />

      {/* 2. KURUMSAL HAKKIMIZDA YAZISI */}
      <div style={{ padding: '60px 20px', textAlign: 'center', background: 'white' }}>
        <h2 style={{ color: '#0a1a2f', fontSize: '2.5rem', marginBottom: '20px' }}>
        ...
        <p style={{ maxWidth: '800px', margin: '0 auto', fontSize: '1.1rem', color: '#555', lineHeight: '1.8' }}>
          ...
          Siz kahvenizi yudumlarken, biz yeni yuvanızı kuruyoruz.
        </p>

        {/* 3. İSTATİSTİKLER (Hava katar) */}
        <div style={{ display: 'flex', justifyContent: 'center', gap: '50px', marginTop: '50px', flexWrap: 'wrap' }}>
          <div>
