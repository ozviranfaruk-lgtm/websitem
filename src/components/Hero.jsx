...
function Hero() {
  ...
  // Şehir verileri (Eksiksiz Tam Liste)
...
Swal.fire({ 
  ...
  const inputStyle = { width: '100%', padding: '12px', border: '1px solid #ccc', borderRadius: '10px', boxSizing: 'border-box', fontSize: '14px', outline:'none' };
  const labelStyle = { display: 'block', marginBottom: '4px', fontWeight: 'bold', fontSize: '12px', color:'#0a1a2f' };
  const buttonStyle = { width: '100%', padding: '16px', background: 'linear-gradient(135deg, #d90429, #a8001d)', color: 'white', border: 'none', borderRadius: '10px', fontWeight: 'bold', fontSize: '17px', cursor: 'pointer', marginTop: '15px', boxShadow: '0 5px 15px rgba(217, 4, 41, 0.4)' };

  return (
    <div style={heroSectionStyle}>
      <div style={contentContainer}>
        
        {/* SOL TARAFTAKİ HEYBETLİ YAZILAR */}
        <div style={textSide}>
          <h1 style={{ fontSize: 'clamp(2.5rem, 6vw, 4rem)', fontWeight: '900', lineHeight: '1.1', marginBottom: '15px', textShadow: '2px 2px 10px rgba(0,0,0,0.5)' }}>
            PROFLASH <br /> <span style={{ color: '#ffb703' }}>NAKLİYAT</span>
          </h1>
          <p style={{ fontSize: '1.3rem', marginBottom: '35px', color: '#f0f0f0', fontWeight: '500' }}>
          ...
          <div style={{ color: '#ffb703', fontWeight: 'bold', fontSize: '1.1rem' }}>
