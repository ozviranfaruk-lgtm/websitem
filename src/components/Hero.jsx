...
function Hero() {
  ...
  const heroSectionStyle = {
    ...
    alignItems: 'center',
    padding: '40px 10px', // Kenar boşluğunu telefonda azalttık
    color: 'white'
  };

  const contentContainer = {
    display: 'flex',
    flexWrap: 'wrap', // Mobilde alt alta geçmeyi sağlar
    maxWidth: '1200px',
    width: '100%',
    justifyContent: 'center', // Merkeze çektik
    alignItems: 'center',
    gap: '30px'
  };
  ...
  const textSide = {
    flex: '1',
    minWidth: '280px',
    textAlign: 'center' // Mobilde yazıların ortalı durması daha şık
  };
  ...
  const formSide = {
    ...
    padding: '20px', // İç boşluğu biraz daralttık
    borderRadius: '15px',
    color: '#333',
  ...
  // Satır stili: Mobilde alt alta, PC'de yan yana
  const rowStyle = { 
    display: 'flex', 
    gap: '10px', 
    flexWrap: 'wrap', // Sır bu: Sığmayınca alt alta atar
    marginBottom: '10px' 
  };

  const colStyle = { flex: '1', minWidth: '130px' }; // Mobilde sığmazsa 130px'in altına düşmez, alt satıra geçer

  const inputStyle = { width: '100%', padding: '10px', border: '1px solid #ccc', borderRadius: '8px', boxSizing: 'border-box' };
  const labelStyle = { display: 'block', marginBottom: '3px', fontWeight: 'bold', fontSize: '13px', color:'#0a1a2f' };
  ...
  return (
    <div style={heroSectionStyle}>
      <div style={contentContainer}>
        ...
        <div style={textSide}>
          <h1 style={{ fontSize: 'clamp(2rem, 8vw, 3.5rem)', fontWeight: '900', lineHeight: '1.2', marginBottom: '15px' }}>
            PROFESYONEL <br /> <span style={{ color: '#ffb703' }}>EVDEN EVE</span> <br /> NAKLİYAT
          </h1>
          <p style={{ fontSize: '1.1rem', marginBottom: '25px', color: '#ddd' }}>
            Türkiye'nin 81 iline sigortalı ve asansörlü taşımacılık.
          </p>
          <div style={{ display: 'flex', gap: '15px', justifyContent: 'center' }}>
             <div style={{display:'flex', alignItems:'center', gap:'8px'}}>
                <div style={{width:'40px', height:'40px', background:'#d90429', borderRadius:'50%', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'1.2rem'}}>🛡️</div>
                <div style={{textAlign:'left'}}><strong style={{fontSize:'0.9rem'}}>Sigortalı</strong></div>
             </div>
             <div style={{display:'flex', alignItems:'center', gap:'8px'}}>
                <div style={{width:'40px', height:'40px', background:'#d90429', borderRadius:'50%', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'1.2rem'}}>🏗️</div>
                <div style={{textAlign:'left'}}><strong style={{fontSize:'0.9rem'}}>Asansörlü</strong></div>
             </div>
          </div>
        </div>
        ...
        {/* SAĞ TARAFTAKİ FORM */}
        <div style={formSide}>
          <h2 style={{ textAlign: 'center', color: '#0a1a2f', fontSize: '1.5rem', marginBottom:'15px' }}>Hemen Fiyat Al ⚡</h2>
